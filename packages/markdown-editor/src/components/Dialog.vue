...
<template>
  <div ref="modalRef" class="import-modal byte-modal" style="display: none;">
    <div class="byte-modal__mask" style="z-index: 1005;" />
    <div class="byte-modal__wrapper" style="z-index: 1005;" @click="close($event)">
      <div class="byte-modal__content" style="width: 500px;">
        <div class="byte-modal__header">
          <span class="byte-modal__title">文章导入</span>
          <span aria-label="Close" class="byte-modal__headerbtn" @click="close">
            <i class="byte-icon byte-icon--close">
              <svg
                t="1561638608887" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          class="byte-modal__body" @click="selectMD($event)" @drop.prevent="onDrop" @dragover.prevent="onDragover"
